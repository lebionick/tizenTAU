...
function getFeed(){
	...
	indicator.style.visibility = "visible";
    	...
    	var arr = [];
    	var i=0;
	 var FEED_URL =  "http://www.3dnews.ru/news/rss/";//"https://news.yandex.ru/index.rss";//"http://www.3dnews.ru/news/rss/";
	 ...
	 $(document).ready(function () {
		    $.ajax({
			    ...
			    //	$("#rssContent").append("key: " + field + "<br> значение: " + value[fieldValue] + "<br><br>-------------<br>");
					        $("#rssContent").append('<div class="feed"><div class="image"><img src="' + url + '" width=' + width + 'px /><div class="title"> Title:' + title 
					        		+ '</div><br><div class="description">description: ' + description + '</div> <div class="pubDate"> pubDate: ' + date + '</div> </div>');
			    		}
			    		}),
		        success: xmlParser
		    });
		...
		//  delData(1054);
		    $(xml).find("item").each(function () {
		    	  ...
		    	  var base64 = urlToBase64Fat( $(this).find("enclosure").attr('url') );

		    	  
			        $("#rssContent").append('<div class="feed"><div class="image"><img src=' + base64 + ' width=' + width + 'px /><div class="title"> Title:' + $(this).find("title").text() 
		          ...
		          arr[i] = { title:$(this).find("title").text(), description:$(this).find("description").text(),
		        		  image:base64, pubDate:$(this).find("pubDate").text() } ;
